...
Thank you for your interest in contributing to UniTSFM! We welcome
contributions of all forms -- bug reports, feature requests, documentation
...
.. code-block:: python
    ...
    class MyModelForecaster(BaseForecaster):
        ...
        def fit(self, y, X=None, freq=None, **kwargs):
            ...
        def predict(self, horizon, return_quantiles=False, **kwargs):
            ...
